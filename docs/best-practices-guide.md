...
The intelligent-code-agents system automatically discovers and injects best-practices from your project's `best-practices/` directory during AgentTask generation. This allows you to customize AgentTask templates without modifying the core system.
